...
public class NoMain {
    public static void main(String[] args) {
        ...
        encadeamentoDeNos<String> no1 = new encadeamentoDeNos<>("Conteudo no1"); //criando o primeiro nó

        encadeamentoDeNos<String> no2 = new encadeamentoDeNos<>("Conteudo no2");//criando o segundo nó
        no1.setProximoNo(no2); //apontando o primeiro nó para o segundo nó

        encadeamentoDeNos<String> no3 = new encadeamentoDeNos<>("Conteudo no3");//criando o terceiro nó
        no2.setProximoNo(no3);//apontando o segundo nó para o terceiro nó

        encadeamentoDeNos<String> no4 = new encadeamentoDeNos<>("Conteudo no4");//criando o quarto nó
